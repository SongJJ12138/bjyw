...
import com.hbcx.bjckyh.adapter.TransFormersViewHolder
import com.hbcx.bjckyh.bean.Nav
import com.hbcx.bjckyh.bean.Notify
import com.hbcx.bjckyh.network.HttpManager
import com.hbcx.bjckyh.network.request
import com.hbcx.bjckyh.utils.dp2px
...
class MainActivity : BaseActivity() {
    ...
    private fun getOrder() {
        HttpManager.getOrder().request(this@MainActivity){ _,data ->
            data.let {
                if (it!=null&&it.size>0){
                    navList[1] = Nav(1,"次日工单", com.hbcx.bjckyh.R.mipmap.main_ciri,true,"待完成")
    ...
    private val navList:ArrayList<Nav> by lazy {
        ...
        navList.add(Nav(0,"巡检工单", com.hbcx.bjckyh.R.mipmap.main_xunjain,false,""))
        navList.add(Nav(1,"次日工单", com.hbcx.bjckyh.R.mipmap.main_ciri,false,""))
        navList.add(Nav(2,"维修工单", com.hbcx.bjckyh.R.mipmap.maia_weixiu,false,""))
        navList.add(Nav(3,"拆建工单", com.hbcx.bjckyh.R.mipmap.main_chaijian,false,""))
        navList.add(Nav(4,"台站采集", com.hbcx.bjckyh.R.mipmap.main_caiji,false,""))
        navList.add(Nav(5,"我的小组", com.hbcx.bjckyh.R.mipmap.main_wode,false,""))
        navList.add(Nav(6,"工作统计", com.hbcx.bjckyh.R.mipmap.main_gongzuo,false,""))
        navList.add(Nav(7,"本地备忘录", com.hbcx.bjckyh.R.mipmap.main_bendi,false,""))
        navList
    }
    private fun isCard() {
