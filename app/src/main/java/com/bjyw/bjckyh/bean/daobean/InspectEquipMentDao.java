...
public class InspectEquipMentDao extends AbstractDao<InspectEquipMent, Long> {
    ...
    public static class Properties {
        ...
        public final static Property EquipmentIndex = new Property(2, String.class, "equipmentIndex", false, "EQUIPMENT_INDEX");
        ...
        public final static Property Is_exist = new Property(7, String.class, "is_exist", false, "IS_EXIST");
    ...
    protected final void bindValues(DatabaseStatement stmt, InspectEquipMent entity) {
        ...
        if (equipmentIndex != null) {
            stmt.bindString(3, equipmentIndex);
        }
    ...
    public InspectEquipMent readEntity(Cursor cursor, int offset) {
        InspectEquipMent entity = new InspectEquipMent( //
            ...
            cursor.isNull(offset + 2) ? null : cursor.getString(offset + 2), // equipmentIndex
            ...
            cursor.isNull(offset + 7) ? null : cursor.getString(offset + 7), // is_exist
    ...
    public void readEntity(Cursor cursor, InspectEquipMent entity, int offset) {
        ...
        entity.setEquipmentIndex(cursor.isNull(offset + 2) ? null : cursor.getString(offset + 2));
        ...
        entity.setIs_exist(cursor.isNull(offset + 7) ? null : cursor.getString(offset + 7));
